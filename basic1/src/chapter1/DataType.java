...
public class DataType {
	...
	public static void main(String[] args) {
		...
		// 소수점 6-7 자리에서 오차가 발생
		// 실수형 리터럴 정수는 double 타입임
		float float1 = 3.14159266358979323846F;
		System.out.println(float1);
		
		// double : 8byte(64bit)의 크기를 가지는 실수형 데이터 타입
		// 소수점 15-17 자리에서 오차가 발생
		double double1 = 3.14159266358979323846;
		...
		statement = "내가 그린 기린 그림은 잘 그린 기린 그림이고 내가 그린 기린 그림은 잘 못그린 기린 그림이다.";

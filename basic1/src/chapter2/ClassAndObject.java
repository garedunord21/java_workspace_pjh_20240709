...
class ExampleClass1 {
	...
	// 기능 : 클래스가 가질수 있는 행동이나 역할 (메서드)
	
	// [접근제어자] 반환타입 메서드명 (매개변수타입 매개변수형[, ...])
	// { 메서드 기능 구현 }
	...
	int method1 (int arg1) {
		// 기능 구현
		// 반환타입이 void 아니면 반드시 return으로 결과값을 반환해야 함
		return arg1 * arg1;
	}
...
class SmartPhone {
	...
	void call(String toTelNumber) {
		System.out.println(telNumber + "가 " + toTelNumber + "또 전화를 겁니다.");
	}

...
public class Package3 {
	...
	public static void main(String[] args) {
		...
		// 특정 날짜 및 시간의 인스턴스 생성
		LocalDateTime date1 = LocalDateTime.of(2024, 7, 9, 9, 30, 0, 0);
		...
		// y: 연도, M: 월, d: 일, a: 오전오후, H: 시간(24), h:시간(12)
		// 오전 10ㅣ23 2024-07-17
		Format computerFormat = new SimpleDateFormat("a hh:mm:ss yyyy-MM-dd");
